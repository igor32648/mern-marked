        ...
        <main className='p-3 max-w-4xl mx-auto'>
            ...
            <form className='flex flex-col sm:flex-row gap-4'>
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    rounded-lg' id='name' maxLength='20' minLength='3' required />
                    <textarea type='text' placeholder='Description' className='border p-3
                    rounded-lg' id='description' maxLength='200' minLength='3' required />
                    <input type='text' placeholder='Adress' className='border p-3
                    rounded-lg' id='adress' maxLength='40' minLength='3' required />
